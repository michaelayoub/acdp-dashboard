...
import { QUERY as INT_PROPS_QUERY, processIntPropsChunk } from '$lib/model/queries/MinimalCharacterIntProperties';
import type { ReadableStream } from "node:stream/web";
import { event } from 'sveltekit-sse';

export async function GET() {
    const intPropsResponse = await pushQuery(INT_PROPS_QUERY);
